        ...
        req = await urllib.request(process.env.WEBHOOK_URL, {
            ...
            data: {
                ...
                embeds: [{
                    ...
                    color: (((now.leader_party_id == 'republican') && (now.leader_margin_value > then.leader_margin_value)) || ((now.leader_party_id == 'democrat') && (now.leader_margin_value < then.leader_margin_value))) ? 0xfc0303 : 0x03fc20,
